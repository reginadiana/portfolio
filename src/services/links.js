...
export const portfolio = {
  frontend: {
    ...
    amoPlantas: {
      title: "Amo Plantas",
      description:
        "Plataforma para recomendação de plantas a partir da escolha da intensidade de raios solares, frenquencia de rigação e se o usuário possui pets.",
      github:
  ...
  lives: {
    readme: {
      title: "[LIVE] Como escrever e personalizar um README no Github",
      description:
    ...
    treinaDev: {
      title: "Apresentação da 5 turma do Treina Dev - Campus Code",
      description:
