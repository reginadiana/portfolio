  ...
  backend: {
    headhunter: {
      ...
      description:
        ...
        recebam instrições, assim como candidatos possam buscar e se canditadar a elas. ",
      github:
        "https://github.com/React-Bootcamp-WoMarkersCode/certificate-generator",
    ...
    rentalCars: {
      ...
      description:
        ...
        O administrador pode criar uma conta e agendar uma locação, escolhendo o modelo do carro, categoria,\
        data de agendamento, etc.",
      github:
        "https://github.com/React-Bootcamp-WoMarkersCode/certificate-generator",
      deploy: null,
      techs: ["html", "css", "rails", "ruby", "tdd"],
